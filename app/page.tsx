        ...
        <div className="container py-24 md:py-32 lg:py-40">
          <div className="mx-auto max-w-4xl text-center space-y-8 animate-fade-in">
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground leading-relaxed">
              一个基于 Web 的深度学习可视化平台，通过交互式动画和沙盒工具，
              让 AlexNet、ResNet 等复杂的神经网络变得<span className="font-semibold text-foreground">直观易懂</span>。
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group relative overflow-hidden rounded-xl border bg-card p-8 transition-all hover:shadow-lg">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  ...
                  每一层的参数、每一个设计决策，都有清晰的标注和解释。
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground mb-6">
                  <li className="flex items-center">
                    <span className="mr-2 h-1.5 w-1.5 rounded-full bg-primary" />
                    LeNet、AlexNet、VGG、ResNet 等经典模型
                  </li>
                  <li className="flex items-center">
                    <span className="mr-2 h-1.5 w-1.5 rounded-full bg-primary" />
                    支持暂停、步进和视角切换
              ...
              <div className="group relative overflow-hidden rounded-xl border bg-card p-8 transition-all hover:shadow-lg">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  你的神经网络创意工坊。通过拖拽卷积层、激活函数等基础组件，
                  自由搭建和探索模型架构。实时查看张量形状变化，理解数据流动。
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground mb-6">
                  <li className="flex items-center">
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl text-center space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              NeuronCanvas 是一个完全开源的项目。我们相信知识应该自由流动，
              创新应该被分享。欢迎在 GitHub 上为这个项目贡献你的力量。
            </p>
